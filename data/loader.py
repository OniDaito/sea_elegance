...
class WormDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        with fits.open(img_path) as w:
            ...
            source_image = nd.interpolation.zoom(source_image, zoom=0.25)
        ...
        with fits.open(img_path) as w:
            ...
            target_asi = nd.interpolation.zoom(target_asi, zoom=0.25)
        ...
        with fits.open(img_path) as w:
            ...
            target_asj = nd.interpolation.zoom(target_asj, zoom=0.25)
